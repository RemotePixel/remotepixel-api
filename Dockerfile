...
RUN pip3 install git+https://github.com/RemotePixel/remotepixel-py.git@22bbae4c0111e0682aa278a967c459cde6c933cd aws-sat-api==0.0.5 --no-binary numpy -t /tmp/vendored -U
